      ...
      initContainers:
        - name: init-permissions
          ...
          command:
            ...
            - -c
            - |
              mkdir -p /var/lib/postgresql/17/main/pgdata
              chmod 0700 /var/lib/postgresql/17/main/pgdata
              chown -R 999:999 /var/lib/postgresql/17
          volumeMounts:
      ...
      containers:
        - name: postgresql
          ...
          env:
            ...
            - name: PGDATA
              value: /var/lib/postgresql/17/main/pgdata
          ports:
            - containerPort: 5432
              name: postgresql
          volumeMounts:
